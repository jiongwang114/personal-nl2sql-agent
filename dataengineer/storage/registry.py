...
from dataengineer.storage.embedding_models import get_embedding_model
...
def _get_storage_cached(factory_name: str, embedding_model_conf_name: str, project: str) -> BaseEmbeddingStore:
    ...
    from dataengineer.storage.subject_tree.store import BaseSubjectEmbeddingStore
    ...
    **defaults: Any,
    ...
    Args:
        ...
        data_dir: Root data directory for file-based backends (e.g.
            ``~/.dataengineer/data``).  Passed to ``init_backends()``.
    ...
    Example (CLI — default sqlite + lance)::
        ...
        preload_all_storages(data_dir="~/.dataengineer/data", project="my_project")
    """
    ...
    from dataengineer.storage.reference_sql.store import ReferenceSqlStorage
    from dataengineer.storage.schema_metadata.store import SchemaStorage, SchemaValueStorage
    from dataengineer.storage.semantic_model.store import SemanticModelStorage
...
def clear_storage_registry() -> None:
    ...
    """
    from dataengineer.storage.backend_holder import reset_backends
