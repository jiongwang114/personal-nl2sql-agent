...
from dataengineer.storage.document.fetcher.rate_limiter import RateLimiter, get_rate_limiter
from dataengineer.storage.document.schemas import SOURCE_TYPE_GITHUB, FetchedDocument
...
class GitHubFetcher(BaseFetcher):
    ...
    def _resolve_nav_map(
        ...
        """
        try:
            from dataengineer.storage.document.nav_resolver import NavResolverPipeline
