...
from dataengineer.storage.document.nav_resolver.base_resolver import BaseNavResolver
from dataengineer.storage.document.nav_resolver.detector import (
...
from dataengineer.storage.document.nav_resolver.fallback_resolver import FallbackResolver
