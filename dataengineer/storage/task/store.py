...
class TaskStore:
    ...
    def __init__(self, project: str = ""):
        ...
        Args:
            project: Project identifier used for backend isolation. When
                empty, the active ``DataEngineerPathManager.project_name`` is used.
        """
        from dataengineer.storage.backend_holder import create_rdb_for_store
    ...
    def record_feedback(self, task_id: str, status: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not rows:
                raise DataEngineerException(ErrorCode.STORAGE_FAILED, message=f"Task {task_id} not found")
    ...
    def get_all_feedback(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise DataEngineerException(ErrorCode.STORAGE_FAILED, message=f"Failed to get all feedback: {str(e)}") from e
    ...
    def create_task(self, task_id: str, task_query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise DataEngineerException(ErrorCode.STORAGE_FAILED, message=f"Failed to create task {task_id}: {str(e)}") from e
    ...
    def update_task(self, task_id: str, sql_query: str = None, sql_result: str = None, status: str = None) -> bool:
        ...
        try:
            ...
            raise DataEngineerException(ErrorCode.STORAGE_FAILED, message=f"Failed to update task {task_id}: {str(e)}") from e
    ...
    def get_task(self, task_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            raise DataEngineerException(ErrorCode.STORAGE_FAILED, message=f"Failed to get task {task_id}: {str(e)}") from e
    ...
    def delete_task(self, task_id: str) -> bool:
        ...
        try:
            ...
            raise DataEngineerException(ErrorCode.STORAGE_FAILED, message=f"Failed to delete task {task_id}: {str(e)}") from e
    ...
    def cleanup_old_tasks(self, hours: int = 24) -> int:
        ...
        try:
            ...
            raise DataEngineerException(ErrorCode.STORAGE_FAILED, message=f"Failed to cleanup old tasks: {str(e)}") from e
