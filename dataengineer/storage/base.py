...
class BaseEmbeddingStore(StorageBase):
    ...
    def _check_embedding_model_ready(self):
        ...
        try:
            ...
            # Re-raise DataEngineerException directly to avoid nesting
            raise e
    ...
    def store_batch(self, data: List[Dict[str, Any]]):
        ...
        try:
            ...
            raise DataEngineerException(ErrorCode.STORAGE_SAVE_FAILED, message_args={"error_message": str(e)}) from e
