...
from dataengineer.gateway.models import ChannelConfig, InboundMessage, OutboundMessage, ReactionEvent
...
from dataengineer.gateway.richtext.ir import MarkdownIR, StyleType
from dataengineer.gateway.richtext.render import RenderOptions, StyleMarker, render_ir

if TYPE_CHECKING:
    from dataengineer.gateway.bridge import ChannelBridge
