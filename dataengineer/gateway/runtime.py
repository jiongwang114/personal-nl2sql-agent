...
"""DataEngineerGateway — lifecycle orchestrator for IM channel adapters."""
...
from dataengineer.gateway.channel.registry import get_adapter_class, register_builtins
