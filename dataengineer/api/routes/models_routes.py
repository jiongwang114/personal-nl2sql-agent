...
from dataengineer.api.deps import ServiceDep
from dataengineer.api.models.base_models import Result
from dataengineer.api.models.config_models import ModelInfo, ModelPricing, ModelsData
from dataengineer.cli.provider_model_catalog import load_cache_fetched_at, load_cached_model_details
...
def _model_spec(catalog: Dict[str, Any], slug: str) -> Dict[str, Any]:
    ...
    ``dataengineer/conf/providers.yml:154-155``: the longest spec key that is a prefix
