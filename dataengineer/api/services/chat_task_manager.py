...
class ChatTaskManager:
    ...
    Owned by DataEngineerService — one instance per cached project.
    """
    ...
    def _create_node(
        ...
        if subagent_id:
            if subagent_id == "gen_semantic_model":
                from dataengineer.agent.node.gen_semantic_model_agentic_node import (
                ...
                from dataengineer.agent.node.gen_ext_knowledge_agentic_node import (
