...
class DataEngineerService:
    ...
    def tool(self):
        if self._tool is None:
            from dataengineer.api.services.tool_service import ToolService
    ...
    def success_story(self):
        if self._success_story is None:
            from dataengineer.api.services.success_story_service import SuccessStoryService
