...
from dataengineer.api.models.kb_models import (
    BootstrapDocInput,
    BootstrapKbEvent,
    BootstrapKbInput,
    KbComponent,
...
from dataengineer.storage.metric.metric_init import init_success_story_metrics
...
class KbService:
    ...
    def _build_args(request: BootstrapKbInput, project_root: str) -> types.SimpleNamespace:
        """Create a SimpleNamespace mimicking argparse.Namespace for dataengineer init functions."""
    ...
    def _batch_event_to_sse(stream_id: str, component: str, event: BatchEvent) -> BootstrapKbEvent:
        """Convert a dataengineer BatchEvent into our SSE envelope."""
        progress = None
