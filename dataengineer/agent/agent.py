...
from dataengineer.configuration.agent_config import AgentConfig, BenchmarkConfig
...
from dataengineer.storage.ext_knowledge.ext_knowledge_init import init_ext_knowledge, init_success_story_knowledge
from dataengineer.storage.ext_knowledge.store import ExtKnowledgeRAG
from dataengineer.storage.metric.metric_init import init_semantic_yaml_metrics, init_success_story_metrics
from dataengineer.storage.metric.store import MetricRAG
from dataengineer.storage.schema_metadata import SchemaWithValueRAG
from dataengineer.storage.schema_metadata.benchmark_init import init_snowflake_schema
from dataengineer.storage.schema_metadata.benchmark_init_bird import init_dev_schema
from dataengineer.storage.schema_metadata.local_init import init_local_schema
from dataengineer.storage.semantic_model.semantic_model_init import (
    init_semantic_yaml_semantic_model,
    init_success_story_semantic_model,
)
from dataengineer.storage.semantic_model.store import SemanticModelRAG
from dataengineer.tools.db_tools.db_manager import DBManager, db_manager_instance
from dataengineer.utils.benchmark_utils import load_benchmark_tasks
from dataengineer.utils.exceptions import DataEngineerException, ErrorCode
from dataengineer.utils.json_utils import to_str
from dataengineer.utils.loggings import get_logger
from dataengineer.utils.path_utils import safe_rmtree
from dataengineer.utils.time_utils import format_duration_human
from dataengineer.utils.traceable_utils import optional_traceable
...
class Agent:
        ...
        for component in selected_components:
            ...
            if component == "metadata":
                ...
                if hasattr(self.args, "from_adapter") and self.args.from_adapter:
                    ...
                    from dataengineer.storage.semantic_model.adapter_init import init_from_adapter
                ...
                if hasattr(self.args, "from_adapter") and self.args.from_adapter:
                    # Pull from semantic adapter
                    from dataengineer.storage.metric.adapter_init import init_from_adapter
                ...
                from dataengineer.storage.reference_sql import ReferenceSqlRAG
                ...
                from dataengineer.storage.reference_template import ReferenceTemplateRAG
                from dataengineer.storage.reference_template.reference_template_init import init_reference_template
    ...
    def evaluation(self, log_summary: bool = True) -> Dict[str, Any]:
        ...
        from dataengineer.utils.benchmark_utils import evaluate_benchmark_and_report
...
def bootstrap_platform_doc(args: argparse.Namespace, agent_config: AgentConfig):
    ...
    from dataengineer.storage.document import infer_platform_from_source, init_platform_docs
