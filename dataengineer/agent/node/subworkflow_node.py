...
from dataengineer.schemas.subworkflow_node_models import SubworkflowInput, SubworkflowResult
        ...
        try:
            ...
            if start_node:
                ...
                if next_node:
                    ...
                    from dataengineer.agent.evaluate import setup_node_input  # type: ignore
