...
from dataengineer.schemas.feedback_agentic_node_models import FeedbackNodeResult
...
class FeedbackAgenticNode(AgenticNode):
    ...
    def _setup_filesystem_tools(self):
        ...
        so ``.dataengineer/memory/{caller}/**`` lands in the WHITELIST zone — the
    ...
    def _resolve_caller_node_name(self) -> str:
        ...
        at switch time. Falls back to ``"chat"`` — DataEngineer's default top-level
