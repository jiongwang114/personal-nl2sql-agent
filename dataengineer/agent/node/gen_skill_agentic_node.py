...
editing, and scaffolding DataEngineer skills. It exposes filesystem (read+write),
...
from dataengineer.schemas.gen_skill_agentic_node_models import SkillCreatorNodeInput, SkillCreatorNodeResult
from dataengineer.tools.func_tool import DBFuncTool, FilesystemFuncTool
...
class SkillCreatorAgenticNode(AgenticNode):
    ...
    def _setup_full_filesystem_tools(self):
        ...
        ``.dataengineer/skills/`` and ``~/.dataengineer/skills/`` are WHITELIST (writable),
        the rest of the project tree is INTERNAL (also writable by this node),
        ``.dataengineer/`` internals other than skills are HIDDEN (invisible), and
    ...
    def _setup_validate_tool(self):
        ...
        try:
            from dataengineer.tools.func_tool.skill_validate_tool import SkillValidateTool
    ...
    def _setup_session_search_tool(self):
        ...
        try:
            from dataengineer.tools.func_tool.session_search_tool import SessionSearchTool
    ...
    def _get_system_prompt(
        ...
        if self.agent_config:
            ...
            if skills_config and hasattr(skills_config, "directories"):
                ...
                skill_directories = ["./.dataengineer/skills", "~/.dataengineer/skills"]
    ...
    async def execute_stream(
        ...
        try:
            ...
            if isinstance(e, DataEngineerException):
