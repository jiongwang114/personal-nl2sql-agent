...
from dataengineer.tools.func_tool.base import trans_to_function_tool
...
class GenJobAgenticNode(AgenticNode):
    ...
    async def execute_stream(
        ...
        if self.input is None:
            raise DataEngineerException(ErrorCode.COMMON_FIELD_REQUIRED, message_args={"field_name": "input"})
