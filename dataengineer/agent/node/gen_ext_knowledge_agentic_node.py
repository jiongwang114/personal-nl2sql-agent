...
from dataengineer.agent.node.compare_agentic_node import CompareAgenticNode
from dataengineer.cli.execution_state import ExecutionInterrupted
...
from dataengineer.schemas.ext_knowledge_agentic_node_models import ExtKnowledgeNodeInput, ExtKnowledgeNodeResult
from dataengineer.schemas.node_models import SQLContext, SqlTask
from dataengineer.tools.func_tool import DBFuncTool
...
from dataengineer.tools.func_tool.filesystem_tools import FilesystemFuncTool
from dataengineer.tools.func_tool.generation_tools import GenerationTools
from dataengineer.utils.benchmark_utils import ComparisonOutcome, TableComparator
from dataengineer.utils.loggings import get_logger
from dataengineer.utils.message_utils import MessagePart, build_structured_content
from dataengineer.utils.node_utils import build_database_context
...
class GenExtKnowledgeAgenticNode(AgenticNode):
    ...
    def _enable_verify_sql_tool(self) -> None:
        ...
        from dataengineer.tools.func_tool import trans_to_function_tool
    ...
    def _validate_gold_sql(self, gold_sql: str) -> None:
        ...
        Raises:
            DataEngineerException: with code NODE_EXT_KNOWLEDGE_GOLD_SQL_INVALID when
...
"""
    ...
    def _prepare_template_context(self, user_input: ExtKnowledgeNodeInput, gold_sql: Optional[str] = None) -> dict:
        ...
        """
        from dataengineer.utils.node_utils import build_datasource_prompt_context
...
- Do NOT include code block markers (```) in the returned strings"""
    ...
    async def execute_stream(
        ...
        try:
            ...
            # - Non-empty but unrunnable gold_sql: raise DataEngineerException here
    ...
    def _extract_ext_knowledge_and_output_from_response(self, output: dict) -> tuple[Optional[str], Optional[str]]:
        ...
        """
        try:
            from dataengineer.utils.json_utils import strip_json_str
    ...
    def _save_to_db(self, ext_knowledge_file: str):
        ...
        try:
            ...
            from dataengineer.cli.generation_hooks import resolve_kb_sandbox_path
