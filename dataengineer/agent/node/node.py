...
from dataengineer.schemas.action_history import ActionHistory, ActionHistoryManager
from dataengineer.schemas.chat_agentic_node_models import ChatNodeInput, ChatNodeResult
from dataengineer.schemas.date_parser_node_models import DateParserInput, DateParserResult
from dataengineer.schemas.explore_agentic_node_models import ExploreNodeInput, ExploreNodeResult
from dataengineer.schemas.feedback_agentic_node_models import FeedbackNodeInput, FeedbackNodeResult
from dataengineer.schemas.fix_node_models import FixInput
from dataengineer.schemas.gen_sql_agentic_node_models import GenSQLNodeInput, GenSQLNodeResult
...
from dataengineer.schemas.reason_sql_node_models import ReasoningResult
from dataengineer.schemas.schema_linking_node_models import SchemaLinkingInput, SchemaLinkingResult
...
if TYPE_CHECKING:
    from dataengineer.agent.workflow import Workflow
...
class Node(ABC):
    ...
    def new_instance(
        ...
        from dataengineer.agent.node import (
            BeginNode,
            ChatAgenticNode,
            CompareNode,
            DateParserNode,
        ...
        if node_type == NodeType.TYPE_SCHEMA_LINKING:
            ...
            from dataengineer.agent.node.explore_agentic_node import ExploreAgenticNode
            ...
            from dataengineer.agent.node.gen_job_agentic_node import GenJobAgenticNode
            ...
            from dataengineer.agent.node.gen_skill_agentic_node import SkillCreatorAgenticNode
            ...
            from dataengineer.agent.node.gen_dashboard_agentic_node import GenDashboardAgenticNode
            ...
            from dataengineer.agent.node.scheduler_agentic_node import SchedulerAgenticNode
            ...
            from dataengineer.agent.node.feedback_agentic_node import FeedbackAgenticNode
        ...
        if isinstance(input_data, dict):
            try:
                if node_dict["type"] == NodeType.TYPE_SCHEMA_LINKING:
                    ...
                    from dataengineer.schemas.gen_dashboard_agentic_node_models import GenDashboardNodeInput

                    input_data = GenDashboardNodeInput(**input_data)
                elif node_dict["type"] == NodeType.TYPE_SCHEDULER:
                    from dataengineer.schemas.scheduler_agentic_node_models import SchedulerNodeInput
        ...
        if isinstance(result_data, dict):
            try:
                ...
                if node_dict["type"] == NodeType.TYPE_SCHEMA_LINKING:
                    ...
                    from dataengineer.schemas.gen_report_agentic_node_models import GenReportNodeResult

                    result_data = GenReportNodeResult(**result_data)
                elif node_dict["type"] == NodeType.TYPE_EXPLORE:
                    result_data = ExploreNodeResult(**result_data)
                elif node_dict["type"] == NodeType.TYPE_GEN_DASHBOARD:
                    from dataengineer.schemas.gen_dashboard_agentic_node_models import GenDashboardNodeResult

                    result_data = GenDashboardNodeResult(**result_data)
                elif node_dict["type"] == NodeType.TYPE_SCHEDULER:
                    from dataengineer.schemas.scheduler_agentic_node_models import SchedulerNodeResult

                    result_data = SchedulerNodeResult(**result_data)
                elif node_dict["type"] == NodeType.TYPE_GEN_TABLE:
                    from dataengineer.schemas.semantic_agentic_node_models import SemanticNodeResult
