...
from dataengineer.tools.func_tool.attribution_utils import DimensionAttributionUtil
from dataengineer.tools.func_tool.base import FuncToolListResult, FuncToolResult, normalize_null, trans_to_function_tool
from dataengineer.tools.semantic_tools.base import BaseSemanticAdapter
from dataengineer.tools.semantic_tools.models import AnomalyContext
from dataengineer.tools.semantic_tools.registry import semantic_adapter_registry
            ...
            try:
                ...
                if adapter_config is None:
                    ...
                    if metadata and metadata.config_class:
                        ...
                        from dataengineer.tools.semantic_tools.config import SemanticAdapterConfig
