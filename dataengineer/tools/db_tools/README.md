...
```python
from dataengineer.tools.db_tools import DBManager, SQLiteConnector
...
```python
from dataengineer.tools.db_tools import SQLiteConnector
from dataengineer.tools.db_tools.config import SQLiteConfig
from dataengineer.schemas.node_models import ExecuteSQLInput
...
See the project documentation for adapter implementation guidance.
...
```python
from dataengineer.tools.db_tools.base import BaseSqlConnector
from dataengineer.schemas.node_models import ExecuteSQLInput, ExecuteSQLResult
...
def register():
    """Register this adapter with DataEngineer"""
...
- **Query Errors**: Standardized error codes and messages through `DataEngineerException`
