...
class SkillConfig(BaseModel):
    ...
    Attributes:
        directories: List of directories to scan for skills. Project-level
            directories (``./.dataengineer/skills``) take precedence over the global
            fallback (``~/.dataengineer/skills``).
    ...
    directories: List[str] = Field(
        default_factory=lambda: ["./.dataengineer/skills", "~/.dataengineer/skills"],
    ...
    install_dir: str = Field(default="~/.dataengineer/skills", description="Directory for marketplace-installed skills")
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "SkillConfig":
        ...
        return cls(
            ...
            install_dir=data.get("install_dir", "~/.dataengineer/skills"),
        )
