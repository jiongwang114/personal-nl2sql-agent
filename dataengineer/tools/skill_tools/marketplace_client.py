...
from dataengineer.tools.skill_tools.skill_bundle import (
    create_bundle,
...
class SkillMarketplaceClient:
    ...
    def __init__(self, base_url: str = "http://localhost:9000", token: Optional[str] = None):
        ...
        if token:
            ...
            from dataengineer.tools.skill_tools.marketplace_auth import load_token
    ...
    def download_bundle(self, name: str, version: str, dest_dir: Path) -> Path:
        ...
        Args:
            ...
            dest_dir: Directory to extract into (e.g. ~/.dataengineer/skills/{name})
