...
an ever-expanding local list. Failures silently fall back through:
  ...
  L2 Cached file at ~/.dataengineer/cache/openrouter_models.json
  L3 Local catalog from dataengineer/conf/providers.yml
...
# onto the provider keys used in dataengineer/conf/providers.yml.
