...
from dataengineer.cli.init_util import init_metrics, init_semantic_model
from dataengineer.cli.interactive_init import ReferenceSqlStreamHandler
from dataengineer.configuration.agent_config import AgentConfig, DashboardConfig
from dataengineer.configuration.agent_config_loader import configuration_manager
from dataengineer.schemas.agent_models import ScopedContext, SubAgentConfig
...
from dataengineer.tools.bi_tools.dashboard_assembler import (
    ChartSelection,
    DashboardAssembler,
...
from dataengineer.utils.reference_paths import quote_path_segment
from dataengineer.utils.sql_utils import metadata_identifier, parse_table_name_parts
from dataengineer.utils.stream_output import StreamOutputManager
from dataengineer.utils.sub_agent_manager import SubAgentManager
from dataengineer.utils.traceable_utils import optional_traceable

logger = get_logger(__name__)

if TYPE_CHECKING:
    from dataengineer.cli.repl import DataEngineerCLI
...
class BiDashboardCommands:
    def __init__(
        self, agent_config: AgentConfig | "DataEngineerCLI", console: Optional[Console] = None, force: bool = False
    ) -> None:
        self.cli: Optional["DataEngineerCLI"] = None
    ...
    def _prompt_options(self) -> DashboardCliOptions:
        ...
        if not platforms:
            raise ValueError("No BI adapter implementations found. Install one with: pip install dataengineer-agent[bi]")
