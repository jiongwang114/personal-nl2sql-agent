...
"""
Agent, workflow, and node-related commands for the DataEngineer CLI.
...
from dataengineer.agent.evaluate import setup_node_input, update_context_from_node
from dataengineer.agent.node import Node
from dataengineer.agent.workflow import Workflow
from dataengineer.cli.cli_styles import CODE_THEME, print_error, print_success, print_warning
from dataengineer.cli.subject_rich_utils import build_historical_sql_tags
...
from dataengineer.schemas.node_models import ExecuteSQLInput, GenerateSQLInput, OutputInput, SqlTask
...
from dataengineer.tools.output_tools import OutputTool
from dataengineer.utils.constants import DBType
from dataengineer.utils.loggings import get_logger
from dataengineer.utils.rich_util import dict_to_tree
...
class AgentCommands:
    ...
    def __init__(self, cli_instance: "DataEngineerCLI", cli_context):
    ...
    def cmd_darun_screen(self, args: str, task: SqlTask = None):
        ...
        try:
            ...
            from dataengineer.cli.screen import show_workflow_screen
    ...
    def cmd_doc_search(self, args: str):
        ...
        with self.console.status("[green]Searching documentation...[/]"):
            from dataengineer.tools.search_tools.search_tool import SearchTool
