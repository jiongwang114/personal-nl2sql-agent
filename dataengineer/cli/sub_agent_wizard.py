...
from dataengineer.cli.autocomplete import TableCompleter
...
from dataengineer.tools.func_tool import PlatformDocSearchTool
from dataengineer.tools.mcp_tools import MCPTool
from dataengineer.utils.constants import SYS_SUB_AGENTS, DBType
from dataengineer.utils.loggings import get_logger
from dataengineer.utils.reference_paths import normalize_reference_path, quote_path_segment, split_reference_path

logger = get_logger(__name__)

if TYPE_CHECKING:
    from dataengineer.cli import DataEngineerCLI
...
class SubAgentWizard:
    ...
    def __init__(self, cli_instance: "DataEngineerCLI", data: Optional[Union[SubAgentConfig, Dict[str, Any]]] = None):
    ...
    def run(self) -> Optional[SubAgentConfig]:
        ...
        from dataengineer.cli._cli_utils import _run_sub_application
    ...
    def native_tools_choices(self) -> Dict[str, List[str]]:
        from dataengineer.tools.func_tool import ContextSearchTools, DBFuncTool
...
def run_wizard(
    cli_instance: "DataEngineerCLI", data: Optional[Union[SubAgentConfig, Dict[str, Any]]] = None
