...
from dataengineer.configuration.agent_config import DbConfig, file_stem_from_uri
    ...
    def __init__(self, config_path: str):
        ...
        try:
            ...
            if e.code == ErrorCode.COMMON_FILE_NOT_FOUND:
                ...
                console.print("Please run 'dataengineer-agent init' first to create the configuration.")
