...
from dataengineer.cli.execution_state import InteractionBroker, InteractionCancelled
...
class GenerationHooks(AgentHooks):
    ...
    def _sync_reference_template_to_db(
        ...
        """
        try:
            from dataengineer.storage.reference_template.init_utils import (
            ...
            from dataengineer.storage.reference_template.template_file_processor import extract_template_parameters
    ...
    def _sync_reference_sql_to_db(file_path: str, agent_config: AgentConfig, build_mode: str = "incremental") -> dict:
        ...
        """
        try:
            from dataengineer.storage.reference_sql.init_utils import exists_reference_sql, gen_reference_sql_id
