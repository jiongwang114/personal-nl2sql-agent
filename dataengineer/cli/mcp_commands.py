...
"""
MCP-related commands for the DataEngineer CLI.
...
from dataengineer.cli.cli_styles import (
    TABLE_HEADER_STYLE,
    print_empty_set,
    print_error,
    print_info,
...
from dataengineer.cli.screen.mcp_screen import MCPServerApp
from dataengineer.tools.mcp_tools import MCPTool, parse_command_string
