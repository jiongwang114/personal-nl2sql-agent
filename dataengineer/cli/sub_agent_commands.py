...
from dataengineer.cli.cli_styles import TABLE_HEADER_STYLE, print_error, print_success, print_usage, print_warning
from dataengineer.cli.sub_agent_wizard import run_wizard
...
class SubAgentCommands:
    def __init__(self, cli_instance: "DataEngineerCLI"):
        self.cli_instance: "DataEngineerCLI" = cli_instance
