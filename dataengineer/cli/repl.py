...
from dataengineer import __version__
from dataengineer.cli._cli_utils import prompt_input
from dataengineer.cli.agent_commands import AgentCommands
from dataengineer.cli.autocomplete import (
...
from dataengineer.cli.bi_dashboard import BiDashboardCommands
from dataengineer.cli.chat_commands import ChatCommands
from dataengineer.cli.context_commands import ContextCommands
from dataengineer.cli.language_commands import LanguageCommands
from dataengineer.cli.list_selector_app import ListItem, ListSelectorApp
from dataengineer.cli.metadata_commands import MetadataCommands
from dataengineer.cli.model_commands import ModelCommands
from dataengineer.cli.service_commands import ServiceCommands
from dataengineer.cli.slash_registry import GROUP_ORDER, GROUP_TITLES, iter_visible, lookup
from dataengineer.cli.status_bar import StatusBarProvider
from dataengineer.cli.sub_agent_commands import SubAgentCommands
from dataengineer.cli.tui import DataEngineerApp, tui_enabled
from dataengineer.cli.tui.app import EXIT_SENTINEL
from dataengineer.configuration.agent_config_loader import configuration_manager, load_agent_config
from dataengineer.schemas.action_history import ActionHistory, ActionHistoryManager, ActionRole, ActionStatus
from dataengineer.schemas.node_models import SQLContext
from dataengineer.tools.db_tools.db_manager import db_manager_instance
from dataengineer.utils.constants import HIDDEN_SYS_SUB_AGENTS, SYS_SUB_AGENTS, DBType, SQLType
from dataengineer.utils.exceptions import setup_exception_handler
from dataengineer.utils.loggings import get_logger
from dataengineer.utils.sql_utils import parse_sql_type
...
class DataEngineerCLI:
    """Main REPL for the DataEngineer CLI application."""
    ...
    def __init__(self, args, interactive: bool = True):
        ...
        # disabled via ``DATAENGINEER_TUI=0`` as an escape hatch.
        self._use_tui = self.interactive and tui_enabled()
        self.tui_app: Optional[DataEngineerApp] = None
        ...
        from dataengineer.cli.datasource_commands import DatasourceCommands
    ...
    def _get_prompt_text(self):
        ...
        The DataEngineer brand, plan mode, and current agent are now rendered by the
    ...
    def _init_tui_app(self) -> None:
        """Create the persistent ``DataEngineerApp`` and register REPL bindings."""
        ...
        def _s_tab(event):  # noqa: ANN001
            ...
            """
            from dataengineer.cli.tui.console_bridge import run_in_terminal_sync
        ...
        def _c_c(event):  # noqa: ANN001
            ...
            Overrides the default DataEngineerApp binding because the TUI needs a
            handle to the chat node's interrupt_controller, which only
            DataEngineerCLI can resolve.
            """
    ...
    def create_combined_completer(self):
        ...
        from dataengineer.cli.autocomplete import SQLCompleter
    ...
    # there is nothing to rebuild on a switch — see ``dataengineer/agent/agent.py``
    ...
    def _cmd_mcp(self, args):
        from dataengineer.cli.mcp_commands import MCPCommands

        MCPCommands(self).cmd_mcp(args)

    def _cmd_skill(self, args):
        from dataengineer.cli.skill_commands import SkillCommands
