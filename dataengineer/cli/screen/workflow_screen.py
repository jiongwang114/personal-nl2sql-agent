...
"""
Workflow screen module for DataEngineer CLI.
...
from dataengineer.cli.screen.base_app import BaseApp
from dataengineer.schemas.node_models import BaseInput, BaseResult
from dataengineer.utils.loggings import get_logger

logger = get_logger(__name__)

# Configure debug logging based on environment variable
WORKFLOW_SCREEN_DEBUG = os.environ.get("DATAENGINEER_WORKFLOW_DEBUG", "0").lower() in ("1", "true", "yes")
