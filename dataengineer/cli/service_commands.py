...
from dataengineer.cli._render_utils import build_kv_table, build_row_table
from dataengineer.cli.cli_styles import TABLE_HEADER_STYLE, print_error, print_info, print_warning
from dataengineer.cli.service_client import ServiceClient, ServiceClientRegistry, service_type_label
...
class ServiceCommands:
    ...
    # ------------------------------------------------------------------ #
    # Entry points wired into DataEngineerCLI.commands / _execute_internal_command
    # ------------------------------------------------------------------ #
    ...
    def _run_async(self, coro) -> Any:
        ...
        Scheduling this on the shared ``DataEngineerCLI._bg_loop`` would freeze
