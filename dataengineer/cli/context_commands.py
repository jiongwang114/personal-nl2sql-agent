...
This module provides context-related commands for the DataEngineer CLI.
"""

from typing import TYPE_CHECKING

from dataengineer.cli.cli_styles import print_error
from dataengineer.cli.screen import show_subject_screen
...
class ContextCommands:
    ...
    def cmd_catalog(self, args: str):
        ...
        try:
            ...
            from dataengineer.cli.screen import show_catalog_screen
