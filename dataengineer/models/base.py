...
from dataengineer.configuration.agent_config import AgentConfig, ModelConfig
from dataengineer.schemas.action_history import ActionHistory, ActionHistoryManager
from dataengineer.utils.constants import LLMProvider
...
class LLMBaseModel(ABC):  # Changed from BaseModel to LLMBaseModel
    ...
    def create_model(cls, agent_config: AgentConfig, model_name: str = None, **kwargs) -> "LLMBaseModel":
        ...
        module = __import__(f"dataengineer.models.{model_type}_model", fromlist=[model_class_name])
