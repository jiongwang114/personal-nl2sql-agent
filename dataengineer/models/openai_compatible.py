...
from dataengineer.models.litellm_adapter import LiteLLMAdapter
from dataengineer.models.mcp_result_extractors import extract_sql_contexts
from dataengineer.models.mcp_utils import multiple_mcp_servers
...
from dataengineer.utils.text_utils import strip_litellm_placeholder
from dataengineer.utils.traceable_utils import setup_tracing
...
def _load_model_specs() -> Dict[str, Dict[str, int]]:
    ...
    ``~/.dataengineer/cache/openrouter_models.json`` provides a fallback ``context_length``
    ...
    with _MODEL_SPECS_LOCK:
        if _MODEL_SPECS_CACHE is None:
            ...
            try:
                from dataengineer.cli.provider_model_catalog import load_cached_model_details
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                if is_retryable and attempt < max_retries:
                    ...
                    raise DataEngineerException(error_code)
            except Exception as e:
