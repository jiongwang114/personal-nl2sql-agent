...
from dataengineer.utils.loggings import get_log_manager, get_logger
...
class DataEngineerException(Exception):
...
def setup_exception_handler(console_logger=None, prefix_wrap_func=None):
    ...
    def global_exception_handler(type, value, tb):
        ...
        log_prefix = (
            "Execution failed" if type == DataEngineerException or issubclass(type, DataEngineerException) else "Unexpected failed"
        )
