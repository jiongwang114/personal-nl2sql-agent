...
def package_data_path(resource_path: str, package: str = "dataengineer") -> Optional[Path]:
...
def read_data_file(resource_path: str, package: str = "dataengineer") -> bytes:
    with package_data_path(resource_path, package) as path:
        return path.read_bytes()


def read_data_file_text(resource_path: str, package: str = "dataengineer", encoding="utf-8") -> str:
...
def copy_data_file(resource_path: str, target_dir: Union[str, Path], package: str = "dataengineer", replace: bool = False):
    """
