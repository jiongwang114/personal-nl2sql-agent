...
from dataengineer.cli.tutorial import BenchmarkTutorial
from dataengineer.multi_round_benchmark import multi_benchmark, setup_base_parser_args
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="DataEngineer: AI-powered SQL Agent for data engineering",
        parents=[global_parser],
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )

    # Add version argument
    parser.add_argument("-v", "--version", action="version", version=f"DataEngineer Agent {__version__}")
...
def main():
    ...
    if args.action == "platform-doc":
        ...
        from dataengineer.agent.agent import bootstrap_platform_doc
