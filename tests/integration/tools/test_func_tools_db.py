...
class TestDBFuncToolIntegrationReal:
    ...
    def ssb_db_tool(self, ssb_sqlite_config):
        ...
        from dataengineer.tools.func_tool.database import db_function_tool_instance_multi
    ...
    def test_single_connector_mode_backward_compatibility(self, ssb_sqlite_config):
        ...
        from dataengineer.tools.func_tool.database import db_function_tool_instance
