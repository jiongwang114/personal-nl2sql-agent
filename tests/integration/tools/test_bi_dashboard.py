...
from dataengineer.cli.bi_dashboard import BiDashboardCommands, DashboardCliOptions
...
from dataengineer.tools.bi_tools.dashboard_assembler import ChartSelection, DashboardAssembler
...
def agent_config(tmp_path_factory) -> AgentConfig:
    ...
    real RAG storage (e.g. `.dataengineer_test_data/...`), and the E2E test's cleanup
    ...
    # developer's real `.dataengineer_test_data/workspace/` — E2E cleanup could then
    ...
    def test_workflow_without_llm(
        ...
        for dashboard_item in input_data:
            ...
            try:
                ...
                with (
                    patch("dataengineer.cli.bi_dashboard.init_reference_sql") as mock_ref_sql,
                    patch("dataengineer.cli.bi_dashboard.init_semantic_model") as mock_semantic,
                    patch("dataengineer.cli.bi_dashboard.init_metrics") as mock_metrics,
