...
from dataengineer.configuration.agent_config import AgentConfig, DocumentConfig
from dataengineer.storage.document.doc_init import init_platform_docs
from dataengineer.storage.document.schemas import (
    CONTENT_TYPE_HTML,
...
from dataengineer.storage.document.store import document_store
from dataengineer.storage.document.streaming_processor import StreamingDocProcessor
...
```python
from dataengineer.plugins import Plugin
...
class TestVersionDetection:
    ...
    def test_detect_versions_from_paths_basic(self):
        ...
        from dataengineer.storage.document.doc_init import _detect_versions_from_paths
...
class TestParserIntegration:
    ...
    def test_rst_parsed_as_markdown(self, local_docs_dir):
        ...
        from dataengineer.storage.document.cleaner.doc_cleaner import DocumentCleaner
        from dataengineer.storage.document.fetcher.local_fetcher import LocalFetcher
        from dataengineer.storage.document.parser.markdown_parser import MarkdownParser
...
class TestChunkerIntegration:
    ...
    def test_chunk_parsed_document(self, local_docs_dir):
        ...
        from dataengineer.storage.document.chunker.semantic_chunker import ChunkingConfig, SemanticChunker
        from dataengineer.storage.document.cleaner.doc_cleaner import DocumentCleaner
        from dataengineer.storage.document.fetcher.local_fetcher import LocalFetcher
        from dataengineer.storage.document.parser.markdown_parser import MarkdownParser
...
class TestGitHubFetcherIntegration:
    ...
    def test_github_fetch_repo_info(self):
        ...
        from dataengineer.storage.document.fetcher.github_fetcher import GitHubFetcher
...
```bash
pip install dataengineer-agent
```
...
```python
from dataengineer import Agent
