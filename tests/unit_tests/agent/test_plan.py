...
"""
Extended unit tests for dataengineer/agent/plan.py.
...
from dataengineer.agent.plan import (
    _create_single_node,
...
from dataengineer.agent.workflow_runner import WorkflowRunner  # noqa: F401 - resolves circular dep
...
class TestGenerateWorkflow:
    ...
    def test_schema_search_failure_does_not_crash(self):
        ...
        with _patched_workflow():
            with patch("dataengineer.storage.schema_metadata.SchemaWithValueRAG", mock_rag_cls):
                wf = generate_workflow(task, plan_type="reflection", agent_config=cfg)
