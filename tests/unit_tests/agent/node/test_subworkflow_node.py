...
class TestSubworkflowNodeExecute:
    ...
    def test_execute_success(self):
        ...
        with patch("dataengineer.agent.node.subworkflow_node.generate_workflow", return_value=mock_subworkflow):
            node.execute()
    ...
    def test_execute_with_start_node_and_one_child(self):
        ...
        with patch("dataengineer.agent.node.subworkflow_node.generate_workflow", return_value=mock_subworkflow):
            ...
            with patch("dataengineer.agent.evaluate.setup_node_input", return_value={"success": True}):
                node.execute()
    ...
    def test_execute_setup_node_input_fails(self):
        ...
        with patch("dataengineer.agent.node.subworkflow_node.generate_workflow", return_value=mock_subworkflow):
            with patch(
                "dataengineer.agent.evaluate.setup_node_input",
