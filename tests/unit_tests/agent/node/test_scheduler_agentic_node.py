...
# `from dataengineer.tools.func_tool.scheduler_tools import SchedulerTools`)
_SCHEDULER_TOOLS_PATCH = "dataengineer.tools.func_tool.scheduler_tools.SchedulerTools"
