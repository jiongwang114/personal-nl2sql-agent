...
class TestFixNodeExecute:
    ...
    def test_execute_calls_autofix_sql(self):
        ...
        with patch("dataengineer.agent.node.fix_node.autofix_sql", return_value=expected):
            node.execute()
    ...
    def test_execute_handles_exception(self):
        ...
        with patch("dataengineer.agent.node.fix_node.autofix_sql", side_effect=RuntimeError("fix error")):
            node.execute()
