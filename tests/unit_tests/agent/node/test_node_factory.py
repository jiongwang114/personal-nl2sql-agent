...
"""
Unit tests for dataengineer/agent/node/node_factory.py
"""
...
from dataengineer.agent.node.node_factory import _resolve_node_class_type, create_interactive_node, create_node_input
...
class TestCreateInteractiveNode:
    @patch("dataengineer.agent.node.chat_agentic_node.ChatAgenticNode.__init__", return_value=None)
    ...
    @patch("dataengineer.agent.node.gen_report_agentic_node.GenReportAgenticNode.__init__", return_value=None)
    ...
    @patch("dataengineer.agent.node.gen_report_agentic_node.GenReportAgenticNode.__init__", return_value=None)
    @patch("dataengineer.agent.node.node_factory._resolve_node_class_type", return_value="gen_report")
    ...
    @patch("dataengineer.agent.node.gen_sql_agentic_node.GenSQLAgenticNode.__init__", return_value=None)
    ...
    @patch("dataengineer.agent.node.gen_table_agentic_node.GenTableAgenticNode.__init__", return_value=None)
    @patch("dataengineer.agent.node.node_factory._resolve_node_class_type", return_value="gen_table")
    ...
    @patch("dataengineer.agent.node.gen_skill_agentic_node.SkillCreatorAgenticNode.__init__", return_value=None)
    @patch("dataengineer.agent.node.node_factory._resolve_node_class_type", return_value="gen_skill")
    ...
    @patch("dataengineer.agent.node.node_factory._resolve_node_class_type", return_value="gen_dashboard")
    ...
    @patch("dataengineer.agent.node.node_factory._resolve_node_class_type", return_value="scheduler")
    ...
    @patch("dataengineer.agent.node.feedback_agentic_node.FeedbackAgenticNode.__init__", return_value=None)
...
class TestCreateNodeInput:
    @pytest.mark.parametrize(
        ...
        [
            (
                "dataengineer.agent.node.chat_agentic_node",
                "ChatAgenticNode",
                "hello",
            ...
            (
                "dataengineer.agent.node.gen_sql_agentic_node",
                "GenSQLAgenticNode",
                "generate SQL",
            ...
            (
                "dataengineer.agent.node.gen_semantic_model_agentic_node",
            ...
            (
                "dataengineer.agent.node.gen_metrics_agentic_node",
            ...
            (
                "dataengineer.agent.node.sql_summary_agentic_node",
            ...
            (
                "dataengineer.agent.node.gen_ext_knowledge_agentic_node",
            ...
            (
                "dataengineer.agent.node.gen_table_agentic_node",
                "GenTableAgenticNode",
                "create table",
                {"catalog": "cat", "database": "db"},
            ...
            (
                "dataengineer.agent.node.gen_report_agentic_node",
            ...
            (
                "dataengineer.agent.node.feedback_agentic_node",
                "FeedbackAgenticNode",
                "analyze and archive",
                {"database": "db"},
    ...
    def test_feedback_source_session_id_wired(self):
        ...
        node_class = _load_node_class("dataengineer.agent.node.feedback_agentic_node", "FeedbackAgenticNode")
        node = MagicMock(spec=node_class)
