...
from dataengineer.schemas.action_history import ActionRole, ActionStatus
...
class TestGenExtKnowledgeNodeExecution:
    ...
    async def test_ext_knowledge_invalid_gold_sql_fails_before_agent_loop(self, real_agent_config, mock_llm_create):
        """Unrunnable gold_sql raises DataEngineerException caught by execute_stream's
        ...
        # Error is wrapped by DataEngineerException template which includes the
...
class TestGenExtKnowledgeSaveToDbSandbox:
    ...
    def test_rejects_out_of_sandbox_absolute_path(self, real_agent_config, mock_llm_create, tmp_path):
        ...
        with patch("dataengineer.cli.generation_hooks.GenerationHooks._sync_ext_knowledge_to_db") as sync_mock:
