...
from dataengineer.agent.node.search_metrics_node import SearchMetricsNode
from dataengineer.schemas.action_history import ActionStatus
from dataengineer.schemas.node_models import Metric, SQLContext, SqlTask
...
class TestSearchMetricsNodeInit:
    ...
    def test_store_property_creates_metric_rag(self):
        ...
        node = _make_node()
        with patch("dataengineer.agent.node.search_metrics_node.MetricRAG") as mock_rag:
