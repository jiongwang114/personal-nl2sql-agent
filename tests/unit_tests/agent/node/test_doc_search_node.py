...
from dataengineer.agent.node.doc_search_node import DocSearchNode
...
class TestSetupInputDocSearch:
    def test_setup_input_sets_input_on_node(self):
        ...
        with patch("dataengineer.agent.node.doc_search_node.DocSearchInput") as mock_input_class:
...
class TestExecuteDocument:
    def test_execute_document_calls_search_tool(self):
        ...
        with patch("dataengineer.agent.node.doc_search_node.SearchTool") as mock_tool_class:
