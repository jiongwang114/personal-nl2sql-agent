...
class TestReasonSQLNodeExecute:
    ...
    def test_execute_success(self):
        ...
        with patch("dataengineer.agent.node.reason_sql_node.reasoning_sql_with_mcp", return_value=expected):
            node.execute()
    ...
    def test_execute_returns_failure_on_exception(self):
        ...
        with patch(
            "dataengineer.agent.node.reason_sql_node.reasoning_sql_with_mcp",
