...
_SEARCH_TOOL_PATH = "dataengineer.tools.search_tools.search_tool.SearchTool"
_TAVILY_PATH = "dataengineer.tools.search_tools.search_tool.search_by_tavily"
...
class TestAvailableTools:
    def test_returns_four_tools(self, doc_search_tool):
        with patch("dataengineer.tools.func_tool.platform_doc_search.trans_to_function_tool") as mock_trans:
