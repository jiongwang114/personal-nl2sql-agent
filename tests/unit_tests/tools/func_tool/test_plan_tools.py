...
from dataengineer.tools.func_tool.plan_tools import PlanTool, SessionTodoStorage, TodoItem, TodoList, TodoStatus
...
class TestPlanTool:
    ...
    def test_available_tools_returns_three(self, plan_tool):
        with patch("dataengineer.tools.func_tool.plan_tools.trans_to_function_tool") as mock_trans:
