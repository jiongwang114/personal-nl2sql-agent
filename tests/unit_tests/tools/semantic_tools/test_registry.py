...
"""Unit tests for dataengineer/tools/semantic_tools/registry.py"""
...
from dataengineer.tools.semantic_tools.registry import AdapterMetadata, SemanticAdapterRegistry
