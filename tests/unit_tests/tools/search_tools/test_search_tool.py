...
"""Unit tests for dataengineer.tools.search_tools.search_tool — _get_document_store."""

from unittest.mock import MagicMock, patch

from dataengineer.schemas.doc_search_node_models import DocSearchInput, DocSearchResult
from dataengineer.tools.search_tools.search_tool import SearchTool, search_by_tavily
...
class TestGetDocumentStore:
    ...
    def test_returns_store_when_has_data(self):
        ...
        with patch("dataengineer.tools.search_tools.search_tool.document_store", return_value=mock_store):
