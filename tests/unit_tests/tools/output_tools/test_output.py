...
"""Unit tests for dataengineer/tools/output_tools/output.py"""

import json
import os
from unittest.mock import MagicMock, patch

from dataengineer.schemas.node_models import OutputInput
from dataengineer.tools.output_tools.output import OutputTool, save_csv, save_json, save_sql
...
class TestOutputToolExecute:
    ...
    def test_check_sql_returns_original_when_model_says_correct(self, tmp_path):
        ...
        with patch("dataengineer.tools.output_tools.output.gen_prompt", return_value="prompt"):
