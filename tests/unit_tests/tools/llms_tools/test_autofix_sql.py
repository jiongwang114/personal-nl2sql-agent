...
"""Unit tests for dataengineer/tools/llms_tools/autofix_sql.py"""
...
from dataengineer.schemas.fix_node_models import FixInput, FixResult
from dataengineer.schemas.node_models import SQLContext, SqlTask, TableSchema
from dataengineer.tools.llms_tools.autofix_sql import autofix_sql
...
class TestAutofixSqlSuccess:
    def test_returns_fix_result_with_dict_response(self):
        ...
        with patch("dataengineer.tools.llms_tools.autofix_sql.fix_sql_prompt", return_value="mock_prompt"):
    ...
    def test_docs_passed_to_prompt(self):
        ...
        with patch("dataengineer.tools.llms_tools.autofix_sql.fix_sql_prompt", return_value="prompt") as mock_prompt:
