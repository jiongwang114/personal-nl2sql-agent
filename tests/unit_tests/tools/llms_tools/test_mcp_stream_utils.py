...
"""Unit tests for dataengineer/tools/llms_tools/mcp_stream_utils.py"""
...
class TestBaseMcpStream:
    ...
    def test_creates_action_history_manager_when_none_provided(self):
        ...
        with patch("dataengineer.tools.llms_tools.mcp_stream_utils.get_prompt_manager") as mock_gpm:
