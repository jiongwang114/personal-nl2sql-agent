...
"""Unit tests for dataengineer/tools/llms_tools/match_schema.py"""
...
from dataengineer.tools.llms_tools.match_schema import MatchSchemaTool, gen_all_table_dict, parse_matched_tables
...
class TestMatchSchemaTool:
    ...
    def test_match_schema_uses_direct_match_for_small_table(self):
        ...
        with (
            patch("dataengineer.tools.llms_tools.match_schema.gen_prompt", return_value="prompt"),
            patch("dataengineer.tools.llms_tools.match_schema.llm_result2json", return_value=[]),
        ):
