...
"""Tests for skill CLI handler (dataengineer/cli/skill_cli.py)."""
...
class TestRunSkillCommand:
    ...
    @patch("dataengineer.cli.skill_cli._get_manager")
    @patch("dataengineer.cli.skill_cli._cmd_list")
    def test_dispatch_list(self, mock_cmd, mock_mgr):
        from dataengineer.cli.skill_cli import run_skill_command
    ...
    @patch("dataengineer.cli.skill_cli._get_manager")
    @patch("dataengineer.cli.skill_cli._cmd_search")
    ...
    @patch("dataengineer.cli.skill_cli._get_manager")
    @patch("dataengineer.cli.skill_cli._cmd_install")
    ...
    @patch("dataengineer.cli.skill_cli._get_manager")
    @patch("dataengineer.cli.skill_cli._cmd_publish")
    ...
    @patch("dataengineer.cli.skill_cli._get_manager")
    @patch("dataengineer.cli.skill_cli._cmd_info")
    ...
    @patch("dataengineer.cli.skill_cli._get_manager")
    @patch("dataengineer.cli.skill_cli._cmd_update")
    ...
    @patch("dataengineer.cli.skill_cli._get_manager")
    @patch("dataengineer.cli.skill_cli._cmd_remove")
...
class TestCmdLogin:
    ...
    @patch("dataengineer.cli.skill_cli.httpx.Client")
    @patch("dataengineer.cli.skill_cli.save_token")
    def test_login_success_via_cookie(self, mock_save, mock_client_cls):
        from dataengineer.cli.skill_cli import _cmd_login
    ...
    @patch("dataengineer.cli.skill_cli.console")
    @patch("dataengineer.cli.skill_cli.httpx.Client")
    ...
    @patch("dataengineer.cli.skill_cli.console")
    @patch("dataengineer.cli.skill_cli.httpx.Client", side_effect=Exception("connect error"))
...
class TestCmdLogout:
    ...
    @patch("dataengineer.cli.skill_cli.clear_token", return_value=True)
    def test_logout_success(self, mock_clear):
        from dataengineer.cli.skill_cli import _cmd_logout

        _cmd_logout("http://localhost:9000")
        mock_clear.assert_called_once_with("http://localhost:9000")

    @patch("dataengineer.cli.skill_cli.clear_token", return_value=False)
...
class TestCmdList:
    ...
    def test_list_no_skills(self, mock_console):
        from dataengineer.cli.skill_cli import _cmd_list
...
class TestCmdSearch:
    ...
    def test_search_no_query(self, mock_console):
        from dataengineer.cli.skill_cli import _cmd_search
...
class TestCmdInstall:
    ...
    def test_install_success(self, mock_console):
        from dataengineer.cli.skill_cli import _cmd_install
...
class TestCmdPublish:
    ...
    def test_publish_success(self, mock_console):
        from dataengineer.cli.skill_cli import _cmd_publish
...
class TestCmdInfo:
    ...
    def test_info_local_only(self, mock_console):
        ...
        from dataengineer.cli.skill_cli import _cmd_info
        from dataengineer.tools.skill_tools.skill_config import SkillMetadata
...
class TestCmdUpdate:
    ...
    def test_update_no_marketplace_skills(self, mock_console):
        ...
        from dataengineer.cli.skill_cli import _cmd_update
        from dataengineer.tools.skill_tools.skill_config import SkillMetadata
...
class TestCmdRemove:
    ...
    def test_remove_success(self, mock_console):
        from dataengineer.cli.skill_cli import _cmd_remove
...
class TestGetManager:
    ...
    def test_get_manager_default(self):
        from dataengineer.cli.skill_cli import _get_manager
