...
"""Tests for SkillCommands (dataengineer/cli/skill_commands.py)."""

from pathlib import Path
from unittest.mock import MagicMock, patch

from dataengineer.tools.skill_tools.skill_config import SkillMetadata


def _make_cli_mock():
    """Create a mock DataEngineerCLI instance."""
    cli = MagicMock()
...
class TestSkillCommandsDispatch:
    ...
    @patch.object(__import__("dataengineer.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_list")
    ...
    @patch.object(__import__("dataengineer.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_search")
    ...
    @patch.object(__import__("dataengineer.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_install")
    ...
    @patch.object(__import__("dataengineer.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_publish")
    ...
    @patch.object(__import__("dataengineer.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_info")
    ...
    @patch.object(__import__("dataengineer.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_update")
    ...
    @patch.object(__import__("dataengineer.cli.skill_commands", fromlist=["SkillCommands"]).SkillCommands, "cmd_skill_remove")
...
class TestSkillCommandsRemove:
    ...
    @patch("dataengineer.cli._cli_utils.confirm_prompt", return_value=True)
...
class TestSkillCommandsLogin:
    @patch("dataengineer.tools.skill_tools.marketplace_auth.save_token")
    @patch("dataengineer.cli._cli_utils.prompt_input", side_effect=["test@test.com", "pass"])
    @patch("httpx.Client")
    ...
    @patch("dataengineer.cli._cli_utils.prompt_input", side_effect=["test@test.com", "wrong"])
    @patch("httpx.Client")
...
class TestSkillCommandsLogout:
    @patch("dataengineer.tools.skill_tools.marketplace_auth.clear_token", return_value=True)
    ...
    @patch("dataengineer.tools.skill_tools.marketplace_auth.clear_token", return_value=False)
