...
from dataengineer.tools.skill_tools.marketplace_auth import (
    _is_token_expired,
    clear_token,
    load_token,
    save_token,
)
from dataengineer.tools.skill_tools.marketplace_client import SkillMarketplaceClient
...
class TestSkillMarketplaceClient:
    ...
    @patch("dataengineer.tools.skill_tools.marketplace_client.httpx.Client")
...
class TestSkillConfigMarketplace:
    ...
    def test_default_marketplace_url(self):
        ...
        assert config.install_dir == "~/.dataengineer/skills"
...
class TestSkillMetadataMarketplace:
    ...
    def test_from_frontmatter_with_license(self):
        ...
        fm = {
            ...
            "description": "test",
            "license": "MIT",
            "compatibility": {"dataengineer": ">=0.2.0"},
        }
        meta = SkillMetadata.from_frontmatter(fm, Path("/tmp/test"))
        assert meta.license == "MIT"
        assert meta.compatibility == {"dataengineer": ">=0.2.0"}
...
class TestMarketplaceAuth:
    ...
    def test_save_and_load_token(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("dataengineer.tools.skill_tools.marketplace_auth.AUTH_FILE", auth_file)
...
class TestMarketplaceClientAuth:
    ...
    def test_client_no_token_returns_empty_headers(self):
        with patch("dataengineer.tools.skill_tools.marketplace_auth.load_token", return_value=None):
            client = SkillMarketplaceClient()
