...
"""Unit tests for dataengineer/cli/action_display/renderers.py (ActionRenderer)."""
...
from dataengineer.cli.action_display.renderers import ActionContentGenerator, ActionRenderer, _get_assistant_content
from dataengineer.schemas.action_history import ActionHistory, ActionRole, ActionStatus
from dataengineer.utils.text_utils import LITELLM_EMPTY_PLACEHOLDER
...
class TestRenderMainAction:
    ...
    def test_user_action(self):
        """USER action renders with DataEngineer> prefix."""
        action = _make_action(
            ActionRole.USER,
            ActionStatus.SUCCESS,
...
class TestUtilityRenderables:
    ...
    def test_user_header(self):
        ...
        assert "DataEngineer>" in text.plain
