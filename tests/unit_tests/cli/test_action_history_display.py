...
"""
Unit tests for dataengineer/cli/action_history_display.py.
...
from dataengineer.cli.action_display.renderers import (
...
from dataengineer.cli.action_display.streaming import _SUBAGENT_ROLLING_WINDOW_SIZE, InlineStreamingContext
...
class TestSubAgentGroupStart:
    ...
    def test_subagent_group_start(self):
        ...
        with patch("dataengineer.cli.action_display.streaming.Live"):
...
class TestRenderActionHistory:
    ...
    def test_user_action_rendered(self):
        """USER action at depth=0 renders user prompt with DataEngineer> prefix."""
        display = ActionHistoryDisplay()
        actions = [
            _make_action(
                ActionRole.USER,
        ...
        printed = self._collect_prints(display, actions)
        assert len(printed) == 1
        assert "DataEngineer>" in printed[0]
...
class TestFormatToolOutputVerbose:
    ...
    def test_empty_output(self):
        ...
        from dataengineer.cli.action_display.tool_content import format_output_verbose
...
class TestGetToolOutputPreview:
    ...
    def test_empty_output(self):
        ...
        from dataengineer.cli.action_display.tool_content import format_generic_preview
    ...
    def test_list_tables_function(self):
        ...
        from dataengineer.cli.action_display.tool_content import _build_list_tables
    ...
    def test_describe_table_function(self):
        ...
        from dataengineer.cli.action_display.tool_content import _build_describe_table
    ...
    def test_read_query_with_original_rows(self):
        ...
        from dataengineer.cli.action_display.tool_content import _build_read_query
    ...
    def test_search_table_function(self):
        ...
        from dataengineer.cli.action_display.tool_content import _build_search_table
    ...
    def test_search_metrics_function(self):
        ...
        from dataengineer.cli.action_display.tool_content import _build_search_metrics
    ...
    def test_search_reference_sql_function(self):
        ...
        from dataengineer.cli.action_display.tool_content import _build_search_reference_sql
    ...
    def test_search_external_knowledge_function(self):
        ...
        from dataengineer.cli.action_display.tool_content import _build_search_external_knowledge
    ...
    def test_search_documents_function(self):
        ...
        from dataengineer.cli.action_display.tool_content import _build_search_documents
...
class TestRenderInteraction:
    ...
    def test_render_interaction_request_text(self):
        ...
        from dataengineer.cli.action_display.renderers import ActionRenderer
