...
from dataengineer.models.litellm_cache_control import (
...
async def test_cache_control_wrapper_applies_markers_when_flag_set():
    ...
    from dataengineer.models.litellm_cache_control import _apply_cache
    ...
    import dataengineer.models.litellm_cache_control as ccmod

    saved = litellm.acompletion
    litellm._dataengineer_cache_control_installed = False  # type: ignore[attr-defined]
    ...
    try:
        ...
        litellm._dataengineer_cache_control_installed = True  # type: ignore[attr-defined]
