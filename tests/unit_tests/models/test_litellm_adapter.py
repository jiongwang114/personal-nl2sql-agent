...
"""
Unit tests for dataengineer/models/litellm_adapter.py
...
from dataengineer.models.litellm_adapter import LiteLLMAdapter, create_litellm_adapter
...
class TestGetAgentsSdkModel:
    ...
    def test_extra_headers_not_passed_to_litellm_model_constructor(self):
        ...
        headers = {"User-Agent": "dataengineer-agent (cli)"}
        adapter = LiteLLMAdapter(provider="claude", model="claude-sonnet-4", api_key="key", default_headers=headers)
        mock_model = MagicMock()
        with patch(
            "dataengineer.models.litellm_cache_control.CacheControlLitellmModel",
...
class TestGetAgentsSdkModelRouting:
    def test_claude_returns_cache_control_subclass(self):
        ...
        from dataengineer.models.litellm_cache_control import CacheControlLitellmModel
