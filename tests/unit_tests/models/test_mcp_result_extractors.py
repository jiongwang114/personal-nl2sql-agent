...
"""
Unit tests for dataengineer/models/mcp_result_extractors.py
...
from dataengineer.models.mcp_result_extractors import extract_sql_contexts, get_function_call_names
