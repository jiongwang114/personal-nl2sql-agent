...
"""Unit tests for dataengineer/utils/memory_loader.py"""

import logging
from unittest.mock import patch

from dataengineer.utils.memory_loader import (
    MEMORY_BASE_DIR,
    MEMORY_BYTE_LIMIT,
    MEMORY_FILENAME,
    MEMORY_LINE_LIMIT,
...
class TestLoadMemoryContext:
    ...
    def test_long_section_triggers_split_warning(self, tmp_path, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="dataengineer.utils.memory_loader"):
