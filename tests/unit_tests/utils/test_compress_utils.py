...
from dataengineer.tools.db_tools import BaseSqlConnector
...
from dataengineer.utils.compress_utils import (
    DataCompressor,
...
class TestIsEmptyData:
    def test_none_is_empty(self):
        from dataengineer.utils.compress_utils import _is_empty_data
...
class TestDataCompressorCompress:
    ...
    @patch("dataengineer.utils.compress_utils.litellm.token_counter", side_effect=_mock_token_counter)
    ...
    @patch("dataengineer.utils.compress_utils.litellm.token_counter")
