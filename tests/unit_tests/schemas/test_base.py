...
"""Unit tests for dataengineer.schemas.base — covers parse_table_type_by_db and base model methods."""

import pytest
from pydantic import Field

from dataengineer.schemas.base import BaseInput, BaseResult, CommonData, parse_table_type_by_db
