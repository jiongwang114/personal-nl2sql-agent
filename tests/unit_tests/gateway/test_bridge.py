...
"""Unit tests for dataengineer.gateway.bridge.ChannelBridge."""
...
from dataengineer.gateway.bridge import _MAX_BOT_MSG_MAP, ChannelBridge
...
class TestChannelBridge:
    ...
    async def test_new_command_clears_session(self, setup):
        ...
        with patch("dataengineer.gateway.bridge.SessionManager") as mock_sm_cls:
            mock_sm = MagicMock()
