...
"""
Unit tests for dataengineer/mcp_server.py
...
from dataengineer.mcp_server import ToolContext, ToolContextManager
...
def context_manager(mock_config_manager):
    with patch("dataengineer.mcp_server.configuration_manager", return_value=mock_config_manager):
...
class TestFormatResult:
    def test_func_tool_result_converted(self):
        from dataengineer.mcp_server import LightweightDynamicMCPServer
...
class TestGetContext:
    def test_raises_when_no_context(self):
        from dataengineer.mcp_server import LightweightDynamicMCPServer, _current_tool_context
