...
"""Unit tests for dataengineer.storage.metric.adapter_init."""
...
class TestInitFromAdapter:
    ...
    @pytest.mark.asyncio
    @patch("dataengineer.storage.metric.adapter_init.SemanticStorageManager")
    @patch("dataengineer.storage.metric.adapter_init.semantic_adapter_registry")
