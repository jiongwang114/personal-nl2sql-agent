...
"""Unit tests for dataengineer.storage.rag_scope."""
...
class TestBuildSubAgentFilter:
    ...
    def test_subject_scope_without_tree_raises(self):
        """Subject-based scope without subject_tree on storage -> raises DataEngineerException."""
        import pytest
        ...
        with pytest.raises(DataEngineerException, match="subject_tree"):
