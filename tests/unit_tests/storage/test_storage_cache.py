...
"""Unit tests for dataengineer.storage.registry (singleton storage)."""

from unittest.mock import MagicMock, patch

import pytest

from dataengineer.storage.registry import (
...
class _DummyStore:
    ...
    def __init__(self, embedding_model, **kwargs):
        ...
        from dataengineer.storage.base import _SharedTableState
...
class TestGetStorage:
    ...
    def test_same_factory_returns_same_instance(self):
        ...
        with patch("dataengineer.storage.registry.get_embedding_model", side_effect=_fake_get_embedding_model):
