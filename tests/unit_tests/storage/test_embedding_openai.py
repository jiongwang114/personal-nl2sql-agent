...
"""Unit tests for dataengineer.storage.embedding_openai (pure logic only, no API calls)."""
...
class TestNdims:
    ...
    def test_unknown_model_raises_value_error(self):
        """An unknown model name should raise DataEngineerException."""
        emb = OpenAIEmbeddings(name="nonexistent-model")
        with pytest.raises(DataEngineerException, match="Unknown embedding model name"):
            emb.ndims()
