...
from dataengineer.storage.reference_template.store import ReferenceTemplateRAG, ReferenceTemplateStorage
from dataengineer.utils.exceptions import DataEngineerException


class TestReferenceTemplateStorage:
    @patch("dataengineer.storage.reference_template.store.BaseSubjectEmbeddingStore.__init__", return_value=None)
...
class TestReferenceTemplateRAG:
    ...
    @patch("dataengineer.storage.rag_scope._build_sub_agent_filter", return_value=None)
    ...
    @patch("dataengineer.storage.rag_scope._build_sub_agent_filter")
    @patch("dataengineer.storage.registry.get_storage")
