...
"""Unit tests for dataengineer.storage.reference_template.reference_template_init."""
...
from dataengineer.storage.reference_template.reference_template_init import (
    BIZ_NAME,
...
class TestInitReferenceTemplateAsync:
    def test_async_function_is_importable(self):
        from dataengineer.storage.reference_template.reference_template_init import init_reference_template_async
...
class TestTemplateExtraInstructions:
    def test_instructions_mention_jinja2(self):
        from dataengineer.storage.reference_template.reference_template_init import TEMPLATE_EXTRA_INSTRUCTIONS
...
class TestProcessTemplateItem:
    ...
    async def test_success_with_complete_yaml(self, tmp_path):
        ...
        from dataengineer.schemas.action_history import ActionHistory, ActionStatus
        from dataengineer.storage.reference_template.reference_template_init import process_template_item
        ...
        with patch(
            "dataengineer.storage.reference_template.reference_template_init.SqlSummaryAgenticNode",
...
class TestInitReferenceTemplateAsyncProcessing:
    ...
    async def test_overwrite_processes_all_items(self, tmp_path):
        ...
        with patch(
            "dataengineer.storage.reference_template.reference_template_init.process_template_item",
    ...
    async def test_incremental_skips_existing(self, tmp_path):
        ...
        from dataengineer.storage.reference_template.init_utils import gen_reference_template_id
        from dataengineer.storage.reference_template.reference_template_init import init_reference_template_async
...
class TestIsSafeIdentifier:
    def test_plain_identifier(self):
        from dataengineer.storage.reference_template.reference_template_init import _is_safe_identifier
...
class TestEnrichDimensionParam:
    def test_enrich_success(self):
        ...
        from dataengineer.storage.reference_template.reference_template_init import _enrich_dimension_param
...
class TestEnrichColumnParam:
    def test_enrich_success(self):
        ...
        from dataengineer.storage.reference_template.reference_template_init import _enrich_column_param
        from dataengineer.tools.func_tool.base import FuncToolResult
...
class TestExtractCsvValues:
    def test_valid_compressed_data(self):
        ...
        from dataengineer.storage.reference_template.reference_template_init import _extract_csv_values
        from dataengineer.tools.func_tool.base import FuncToolResult
