...
"""Unit tests for dataengineer.storage.schema_metadata.benchmark_init."""
...
class TestProcessLine:
    ...
    def test_process_line_catches_exceptions(self):
        ...
        from dataengineer.storage.schema_metadata.benchmark_init import process_line
...
class TestDoProcessByDatabase:
    ...
    def test_skips_nonexistent_directory(self, tmp_path):
        ...
        from dataengineer.storage.schema_metadata.benchmark_init import do_process_by_database
