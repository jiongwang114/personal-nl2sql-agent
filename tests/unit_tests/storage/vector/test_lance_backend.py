...
from dataengineer.storage.vector.lance_backend import LanceVectorBackend, LanceVectorDatabase, LanceVectorTable
...
class TestWrapEmbedding:
    ...
    def test_wrap_fastembed(self):
        ...
        from dataengineer.storage.fastembed_embeddings import FastEmbedEmbeddings
        from dataengineer.storage.vector.lance_backend import _LanceFastEmbedAdapter, _wrap_embedding
    ...
    def test_wrap_openai(self):
        ...
        from dataengineer.storage.vector.lance_backend import _LanceOpenAIAdapter, _wrap_embedding
    ...
    def test_wrap_passthrough_lance_embedding(self):
        ...
        from dataengineer.storage.vector.lance_backend import _wrap_embedding
