...
"""Unit tests for dataengineer.storage.document.fetcher.rate_limiter."""
...
from dataengineer.storage.document.fetcher.rate_limiter import (
    RateLimitConfig,
    RateLimiter,
    RateLimitState,
    get_rate_limiter,
...
class TestCalculateWaitTime:
    ...
    @patch("dataengineer.storage.document.fetcher.rate_limiter.time.time")
...
class TestWait:
    ...
    @patch("dataengineer.storage.document.fetcher.rate_limiter.time.sleep")
    @patch("dataengineer.storage.document.fetcher.rate_limiter.time.time")
