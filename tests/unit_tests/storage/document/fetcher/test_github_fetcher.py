...
"""Unit tests for dataengineer.storage.document.fetcher.github_fetcher."""
...
def _make_fetcher(**kwargs):
    ...
    with patch("dataengineer.storage.document.fetcher.github_fetcher.Github") as MockGithub:
...
class TestGitHubFetchMetadata:
    ...
    def test_metadata_creation(self):
        ...
        from dataengineer.storage.document.fetcher.github_fetcher import GitHubFetchMetadata
