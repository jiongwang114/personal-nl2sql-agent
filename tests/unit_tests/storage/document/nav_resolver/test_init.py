...
"""Tests for dataengineer/storage/document/nav_resolver/__init__.py -- supplemental coverage.
...
from dataengineer.storage.document.nav_resolver import RESOLVER_MAP, NavResolverPipeline, _parse_simple_frontmatter
from dataengineer.storage.document.nav_resolver.detector import FRAMEWORK_DOCUSAURUS, FRAMEWORK_HUGO, FRAMEWORK_MKDOCS
from dataengineer.storage.document.nav_resolver.docusaurus_resolver import DocusaurusResolver
from dataengineer.storage.document.nav_resolver.hugo_resolver import HugoResolver
from dataengineer.storage.document.nav_resolver.mkdocs_resolver import MkDocsResolver
from dataengineer.storage.document.schemas import FetchedDocument
