...
"""Tests for dataengineer.storage.ext_knowledge.store module."""

import pytest

from dataengineer.storage.embedding_models import get_db_embedding_model
from dataengineer.storage.ext_knowledge.store import ExtKnowledgeRAG, ExtKnowledgeStore, gen_subject_item_id
