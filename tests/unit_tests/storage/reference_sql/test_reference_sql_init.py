...
"""Unit tests for dataengineer.storage.reference_sql.reference_sql_init."""
...
from dataengineer.storage.reference_sql.reference_sql_init import BIZ_NAME, _action_status_value
...
class TestInitReferenceSqlAsync:
    ...
    def test_async_function_is_importable(self):
        ...
        from dataengineer.storage.reference_sql.reference_sql_init import init_reference_sql_async
