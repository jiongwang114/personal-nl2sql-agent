...
"""Unit tests for dataengineer/api/routes/config_routes.py."""
...
from dataengineer.api.routes.config_routes import (
...
def _mock_svc(datasources, *, target="deepseek", current_datasource="starrocks", models=None, home="~/.dataengineer"):
    svc = MagicMock()
...
async def test_get_agent_config_flattens_matching_inner_key():
    ...
    assert result.data["home"] == "~/.dataengineer"
