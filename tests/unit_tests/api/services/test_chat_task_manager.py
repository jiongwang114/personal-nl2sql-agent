...
from dataengineer.api.services.chat_task_manager import (
    ChatTask,
    ChatTaskManager,
    _coalesce_deltas,
...
class TestChatTaskManagerBehavior:
    ...
    async def test_push_event_appends_to_buffer(self):
        ...
        from dataengineer.api.models.cli_models import SSEEvent, SSEPingData
...
class TestStartChat:
    ...
    async def test_consume_events_yields_ping_when_idle(self, monkeypatch):
        ...
        from dataengineer.api.models.cli_models import SSEEvent, SSEPingData
        from dataengineer.api.services import chat_task_manager as ctm
...
class TestRunLoopPathManagerContext:
    ...
    async def test_run_loop_does_not_leak_path_manager_to_caller(self, real_agent_config, mock_llm_create):
        ...
        from dataengineer.api.models.cli_models import StreamChatInput
        from dataengineer.utils.path_manager import _current_path_manager, reset_path_manager
...
class TestCreateNodeCustomSubAgent:
    ...
    def test_custom_subagent_resolves_sanitized_key(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "dataengineer.api.services.chat_task_manager.GenSQLAgenticNode",
            _StubGenSQLNode,
        )
